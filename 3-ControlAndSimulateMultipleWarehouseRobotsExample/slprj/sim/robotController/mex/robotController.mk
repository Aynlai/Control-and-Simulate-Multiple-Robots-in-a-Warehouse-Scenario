...
MODULES                 = robotController_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\robotController_msf.mexw64
MAKEFILE                = robotController.mk
MATLAB_ROOT             = D:\Matlab
ALT_MATLAB_ROOT         = D:\Matlab
START_DIR               = C:\Users\Ryan\Documents\MATLAB\Examples\R2024a\robotics\ControlAndSimulateMultipleWarehouseRobotsExample
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:robotController_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = robotController_msf.mexw64
MODELREF_LINK_LIBS        = C:\Users\Ryan\Documents\MATLAB\Examples\R2024a\robotics\ControlAndSimulateMultipleWarehouseRobotsExample\slprj\sim\robotController\robotControllerlib.lib
MODELREF_LINK_RSPFILE     = robotController_ref.rsp
COMPILER_COMMAND_FILE     = robotController_comp.rsp
...
robotController_msf.obj : $(START_DIR)\slprj\sim\robotController\robotController_msf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\sim\robotController\robotController_msf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\robotController\robotController_msf.c
